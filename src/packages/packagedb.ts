...
export interface PackageData {
    ...
    PINNED_PRACTICE_SCORE_LATENCY?: number;
    PULL_REQUEST_RATING_SCORE?: number;
    PULL_REQUEST_RATING_SCORE_LATENCY?: number;
    COST?: number;
...
export const tableCreationQuery = `
    CREATE TABLE IF NOT EXISTS ${tableName} (
        ...
        NET_SCORE FLOAT DEFAULT 0,
        NET_SCORE_LATENCY FLOAT DEFAULT 0,
        RAMP_UP_SCORE FLOAT DEFAULT 0,
        RAMP_UP_SCORE_LATENCY FLOAT DEFAULT 0,
        CORRECTNESS_SCORE FLOAT DEFAULT 0,
        CORRECTNESS_SCORE_LATENCY FLOAT DEFAULT 0,
        BUS_FACTOR_SCORE FLOAT DEFAULT 0,
        BUS_FACTOR_SCORE_LATENCY FLOAT DEFAULT 0,
        RESPONSIVE_MAINTAINER_SCORE FLOAT DEFAULT 0,
        RESPONSIVE_MAINTAINER_SCORE_LATENCY FLOAT DEFAULT 0,
        LICENSE_SCORE INT DEFAULT 0,
        LICENSE_SCORE_LATENCY FLOAT DEFAULT 0,
        PINNED_PRACTICE_SCORE FLOAT DEFAULT 0,
        PINNED_PRACTICE_SCORE_LATENCY FLOAT DEFAULT 0,
        PULL_REQUEST_RATING_SCORE FLOAT DEFAULT 0,
        PULL_REQUEST_RATING_SCORE_LATENCY FLOAT DEFAULT 0,
